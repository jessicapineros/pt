 ...
 <div class="content-custom-post-type">
   <?php if (is_user_logged_in() ): ?>
       ...
       <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
           ...
           <!-- Gallery -->
           <div class="container-gallery tendances">
             <!-- WP Query - Gallery -->
             <?php if( have_rows('gallery_tendances') ): ?>

               <?php while( have_rows('gallery_tendances') ): the_row();

                     $image = get_sub_field('images_gallery_tendances');?>
