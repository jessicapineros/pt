   ...
   <?php if (is_user_logged_in() ): ?>
       ...
       <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
           ...
           <div class="container-gallery">
             <!-- WP Query - Gallery -->
             <?php if( have_rows('gallery_biblioformes') ): ?>

               <?php while( have_rows('gallery_biblioformes') ): the_row();

                     $image = get_sub_field('image_gallery_biblioformes');?>
